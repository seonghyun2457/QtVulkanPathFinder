...
{
public:
    Swapchain(VulkanWidget* iPVulkanWidget, QVulkanInstance* iPqvulkanInstance, const VkPhysicalDevice* iPphysicalDevice, const VkDevice* iPLogicalDevice);
...
private:
    ...
    // Logical Device
    const VkDevice* m_pLogicalDevice{VK_NULL_HANDLE};
